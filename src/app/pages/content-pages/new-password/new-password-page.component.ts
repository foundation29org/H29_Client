        ...
        .subscribe( (res : any) => {
          ...
          this.newPasswordForm.reset();
           ...
           if(errormsg == 'invalid link'){
             swal(this.translate.instant("generics.Warning"), this.translate.instant("recoverpass.invalidLink"), "error");
           }else if(errormsg == 'link expired'){
             swal(this.translate.instant("generics.Warning"), this.translate.instant("recoverpass.expiredLink"), "error");
             this.showlink = true;
           }else{
